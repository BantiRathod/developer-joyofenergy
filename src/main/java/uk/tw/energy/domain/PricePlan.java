...
public class PricePlan {
    ...
    /**
     * This method is going to return consumption cost on particular date. Also Verify that whether day of week on date
     * is peak time or not, if yes then multiple unit rate with multiplier
     * @param dateTime
     * @return
     */
